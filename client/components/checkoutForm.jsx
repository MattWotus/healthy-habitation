  ...
  render() {
    ...
    return (
      <div className='d-flex flex-column boder mt-3 colorWhite'>
        ...
        <div className='row d-flex justify-content-center'>
          <form id='orderForm' className='col-10'>
            <div className="form-group">
              <label htmlFor="name"><h5 className="mb-0">Name</h5></label>
              <input type="text" id="name" className="form-control" name="name" value={name} onChange={this.handleChange} />
            </div>
            <div className="form-group">
              <label htmlFor="creditCard"><h5 className="mb-0">Credit Card</h5></label>
              <input type="text" id="creditCard" className="form-control" name="creditCard" value={creditCard} onChange={this.handleChange} />
            </div>
            <div className="form-group">
              <label htmlFor="shippingAddress"><h5 className="mb-0">Shipping Address</h5></label>
              <textarea id="shippingAddress" className="form-control" rows="5" name="shippingAddress" value={shippingAddress} onChange={this.handleChange} />
            </div>
            <div className='row mb-3'>
              <div className='col-12 d-flex justify-content-between align-items-center'>
                <button onClick={this.handleReset}><h5 className='mb-0 textColor'>&lt; Continue Shopping</h5></button>
                <button onClick={this.handleSubmit} className='btn'><h5 className='btn btn-primary mb-0'>Place Order</h5></button>
              </div>
            </div>
          </form>
        </div>
